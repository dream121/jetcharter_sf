 ...
 */
class BlogPostCategory extends \JetCharters\AppBundle\Entity\BlogPostCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'JetCharters\\AppBundle\\Entity\\BlogPostCategory' . "\0" . 'id', '' . "\0" . 'JetCharters\\AppBundle\\Entity\\BlogPostCategory' . "\0" . 'categoryName', '' . "\0" . 'JetCharters\\AppBundle\\Entity\\BlogPostCategory' . "\0" . 'categorySlug', '' . "\0" . 'JetCharters\\AppBundle\\Entity\\BlogPostCategory' . "\0" . 'blogPost');
        }
    ...
    public function setCategorySlug($categorySlug)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCategorySlug', array($categorySlug));

        return parent::setCategorySlug($categorySlug);
    }
