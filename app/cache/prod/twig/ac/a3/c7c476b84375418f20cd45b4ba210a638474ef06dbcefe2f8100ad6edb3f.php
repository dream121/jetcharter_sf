...
class __TwigTemplate_aca3c7c476b84375418f20cd45b4ba210a638474ef06dbcefe2f8100ad6edb3f extends Twig_Template
{
    ...
    {
        echo "Jet Charter Airport Directory and Hotels Directory";
    }
...
\t    <header class=\"headline airport-bottom-margin\"><h2>AIRPORT DIRECTORY</h2></header>
\t    <div class=\"info airport-paragraph\">
\t\t    <p>With thousands of airports in the world to arrive at, we at Jet Charter Media understand it can be difficult to find the airport information you may need. We can help you find that with our Airport Directory. We even have nearby hotel information and airport maps. Browse around in our Airport Directory to find and US Airports or International Airports.</p>\t
\t    </div>
\t    <h3>Choose your location from our Airport Directory listed below...</h3>
\t    <br>
\t    <div class=\"row\">
\t\t    <div class=\"pull-left col-md-6\">
\t\t\t<table width=\"100%\" border=\"1\" cellpadding=\"1\" cellspaing=\"0\" class=\"airport-table\">
\t\t\t    <tr>
\t\t\t\t    <th colspan=\"2\">US Airport Directory</th>
\t\t\t    </tr>
\t\t\t    <tr>
\t\t\t\t    <td class=\"inner-head\">State</td>
\t\t\t\t    <td class=\"inner-head\">Airport Count</td>
\t\t\t    </tr>
\t\t\t    ";
        // line 26
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["airportsByState"]) ? $context["airportsByState"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["airport"]) {
            // line 27
            echo "\t\t\t    <tr>
\t\t\t\t    <td class=\"inner-td\"><a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("public_airports_list", array("location" => $this->env->getExtension('core_locale')->formatCleanurl($this->getAttribute((isset($context["airport"]) ? $context["airport"] : null), "state")))), "html", null, true);
            echo "\">";
...
\t\t\t\t    <td class=\"inner-td\">";
            // line 29
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["airport"]) ? $context["airport"] : null), "countAirports"), "html", null, true);
            echo "</td>
\t\t\t    </tr>
\t\t\t    ";
        }
...
\t\t\t<table width=\"100%\" border=\"1\" cellpadding=\"1\" cellspaing=\"0\" class=\"airport-table\">
\t\t\t    <tr>
\t\t\t\t    <th colspan=\"2\">International Airport Directory</th>
\t\t\t    </tr>
\t\t\t    <tr>
\t\t\t\t    <td class=\"inner-head\">Country</td>
\t\t\t\t    <td class=\"inner-head\">Airport Count</td>
\t\t\t    </tr>
\t\t\t    ";
        // line 43
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["airportsByCountry"]) ? $context["airportsByCountry"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["airport"]) {
            // line 44
            echo "\t\t\t    <tr>
\t\t\t\t    <td class=\"inner-td\"><a href=\"";
            // line 45
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("public_airports_list", array("location" => $this->env->getExtension('core_locale')->formatCleanurl($this->getAttribute((isset($context["airport"]) ? $context["airport"] : null), "full")))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('core_locale')->formatFormalText($this->getAttribute((isset($context["airport"]) ? $context["airport"] : null), "full")), "html", null, true);
            echo " Airports</a></td>
\t\t\t\t    <td class=\"inner-td\">";
            // line 46
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["airport"]) ? $context["airport"] : null), "airportCount"), "html", null, true);
            echo "</td>
\t\t\t    </tr>
\t\t\t    ";
        }
...
";
    ...
    {
        return "JetChartersPublicBundle:Airport:index.html.twig";
    }
