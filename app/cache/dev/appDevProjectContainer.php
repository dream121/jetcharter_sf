...
class appDevProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'd07495a260521ef80cbb5cc443e58c7b6a401136a230c721acf442e31a7633a2_1' => 'getD07495a260521ef80cbb5cc443e58c7b6a401136a230c721acf442e31a7633a21Service',
            ...
            'gaufrette.image_fs_filesystem' => 'getGaufrette_ImageFsFilesystemService',
    ...
    protected function getD07495a260521ef80cbb5cc443e58c7b6a401136a230c721acf442e31a7633a21Service()
    {
        return $this->services['d07495a260521ef80cbb5cc443e58c7b6a401136a230c721acf442e31a7633a2_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('images', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('videos', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('product_image', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('specsheets', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('images', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('specsheets', $c, $a, $b));
        $d->addEventSubscriber(new \FOS\UserBundle\Doctrine\Orm\UserListener($this));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('images', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('product_image', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('specsheets', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('videos', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('videos', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('product_image', $c, $a, $b));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_62ba5de23254bb0a04acc58d280d024ca195f3f6ce274ba77a6ccd055480f35f');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_62ba5de23254bb0a04acc58d280d024ca195f3f6ce274ba77a6ccd055480f35f');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_62ba5de23254bb0a04acc58d280d024ca195f3f6ce274ba77a6ccd055480f35f');
        ...
        $f->setProxyDir('C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('d07495a260521ef80cbb5cc443e58c7b6a401136a230c721acf442e31a7633a2_1'), $this->get('data_collector.form'));
    }
    ...
    protected function getGaufrette_ImageFsFilesystemService()
    {
        return $this->services['gaufrette.image_fs_filesystem'] = new \Gaufrette\Filesystem(new \Gaufrette\Adapter\Local('C:/xampp/htdocs/Jeremi/JetChartersPHP/app/../web/uploads/images', true));
    }
    ...
    {
        return $this->services['knp_gaufrette.filesystem_map'] = new \Knp\Bundle\GaufretteBundle\FilesystemMap(array('image_fs' => $this->get('gaufrette.image_fs_filesystem'), 'video_fs' => $this->get('gaufrette.video_fs_filesystem'), 'doc_fs' => $this->get('gaufrette.doc_fs_filesystem')));
    }
    ...
    {
        return $this->services['login_listener'] = new \JetCharters\AppBundle\EventListener\SecurityListener($this->get('router'), $this->get('security.context'), $this->get('event_dispatcher'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Jeremi/JetChartersPHP/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/profiler', '', '', 86400), $a);
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/Jeremi/JetChartersPHP/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'JetChartersAppBundle', 1 => 'FOSUserBundle', 2 => 'JetChartersPublicBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Jeremi\\JetChartersPHP\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\Jeremi\\JetChartersPHP\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/../web', false);
        $instance->addWorker(new \Symfony\Bundle\AsseticBundle\Factory\Worker\UseControllerWorker());
        return $instance;
    }
    protected function getAssetic_CacheService()
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Jeremi/JetChartersPHP/app/cache/dev/doctrine/orm/Proxies',
