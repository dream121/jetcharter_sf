 ...
 */
class SiteUser extends \JetCharters\AppBundle\Entity\SiteUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SiteUser $proxy) {
