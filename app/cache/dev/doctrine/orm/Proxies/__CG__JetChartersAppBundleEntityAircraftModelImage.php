 ...
 */
class AircraftModelImage extends \JetCharters\AppBundle\Entity\AircraftModelImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'JetCharters\\AppBundle\\Entity\\AircraftModelImage' . "\0" . 'webpath', '' . "\0" . 'JetCharters\\AppBundle\\Entity\\AircraftModelImage' . "\0" . 'aircraft', '' . "\0" . 'JetCharters\\AppBundle\\Entity\\AircraftModelImage' . "\0" . 'id', 'image', 'imageName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AircraftModelImage $proxy) {
