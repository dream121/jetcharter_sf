 ...
 */
class OperatorUser extends \JetCharters\AppBundle\Entity\OperatorUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'operator', 'position', 'id', 'firstName', 'lastName', 'address1', 'address2', 'city', 'state', 'country', 'zip', 'phone', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OperatorUser $proxy) {
    ...
    public function setRoleValue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRoleValue', array());

        return parent::setRoleValue();
    }
